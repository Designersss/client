...
const Player = observer(() => {
    ...
    console.log(playerMusic.playerMusic)
    const urlCopyFunc = () => {
                ...
                <div className='flex items-center bg-[#1B1B1B] rounded-lg px-10 py-2 justify-between'>
                    ...
                    <div className='flex items-center'>
                        <button className='ml-3'>
                            <svg width="14" height="14" viewBox="0 0 9 10" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M7.93261 9.23074L0.889724 5.35193C0.60582 5.19556 0.60582 4.80455 0.889724 4.64818L7.93261 0.769367C8.21652 0.612997 8.57153 0.808502 8.57153 1.12124L8.57153 8.87886C8.57153 9.1916 8.2167 9.38711 7.93261 9.23074Z"
                                    fill="#F1F1F1"/>
                        ...
                        <button className='ml-3'>
                            <svg width="14" height="14" viewBox="0 0 9 10" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M0.924565 0.769262L7.96745 4.64807C8.25136 4.80444 8.25136 5.19545 7.96745 5.35182L0.924565 9.23063C0.640661 9.387 0.285645 9.1915 0.285645 8.87876V1.12114C0.285645 0.808398 0.640479 0.612892 0.924565 0.769262Z"
                                    fill="#F1F1F1"/>
                    ...
                    <div className='flex items-center'>
                        ...
                        <CopyToClipboard text={'http://cheredfo.beget.tech/music/' + playerMusic.playerMusic.id}>
                            <button onClick={urlCopyFunc}>
                                <div>
                                    {
                                        urlCopy
                                            ? <div className='absolute -mt-12 -ml-10 text-green-500 transition'>Скопировано</div>
                                            : <></>
                                    }
                                </div>
